    ...
    public static class ParseEnumExtensions
    {
        ...
        public static TrackedValue? ParseTrackedValue(this IConfigurationSection section)
        {
            ...
            return val switch
            {
                ...
                "kill_lifemother" => TrackedValue.KillLifemother,
                "kill_lifemother_tier1" => TrackedValue.KillLifemotherTier1,
                "kill_lifemother_tier2" => TrackedValue.KillLifemotherTier2,
                "kill_lifemother_tier3" => TrackedValue.KillLifemotherTier3,
                "soulBuffsApplied" => TrackedValue.SoulBuffsApplied,
                "soulCardsDrafted" => TrackedValue.SoulCardsDrafted,
                "soulCardsPurged" => TrackedValue.SoulCardsPurged,
                "soulCoinsEarned" => TrackedValue.SoulCoinsEarned,
                "soulEnemyUnitsKilled" => TrackedValue.SoulEnemyUnitsKilled,
                "soulEnemyUnitsKilledUsingAwoken" => TrackedValue.SoulEnemyUnitsKilledUsingAwoken,
                "soulEnemyUnitsKilledUsingBanished" => TrackedValue.SoulEnemyUnitsKilledUsingBanished,
                "soulEnemyUnitsKilledUsingHellhorned" => TrackedValue.SoulEnemyUnitsKilledUsingHellhorned,
                "soulEnemyUnitsKilledUsingLazarus" => TrackedValue.SoulEnemyUnitsKilledUsingLazarus,
                "soulEnemyUnitsKilledUsingLunaCoven" => TrackedValue.SoulEnemyUnitsKilledUsingLunaCoven,
                "soulEnemyUnitsKilledUsingPyreborne" => TrackedValue.SoulEnemyUnitsKilledUsingPyreborne,
                "soulEnemyUnitsKilledUsingRailforged" => TrackedValue.SoulEnemyUnitsKilledUsingRailforged,
                "soulEnemyUnitsKilledUsingRemnant" => TrackedValue.SoulEnemyUnitsKilledUsingRemnant,
                "soulEnemyUnitsKilledUsingStygian" => TrackedValue.SoulEnemyUnitsKilledUsingStygian,
                "soulEnemyUnitsKilledUsingUmbra" => TrackedValue.SoulEnemyUnitsKilledUsingUmbra,
                "soulEnemyUnitsKilledUsingUnderlegion" => TrackedValue.SoulEnemyUnitsKilledUsingUnderlegion,
                "soulEnemyUnitsKilledUsingWurm" => TrackedValue.SoulEnemyUnitsKilledUsingWurm,
                "soulEnemyUnitsKilledWithChampion" => TrackedValue.SoulEnemyUnitsKilledWithChampion,
                "soulEnemyUnitsKilledWithPyre" => TrackedValue.SoulEnemyUnitsKilledWithPyre,
                "soulEnemyUnitsKilledWithSpells" => TrackedValue.SoulEnemyUnitsKilledWithSpells,
                "soulEnemyUnitsWithInfestedKilled" => TrackedValue.SoulEnemyUnitsWithInfestedKilled,
                "soulEquipmentPlayed" => TrackedValue.SoulEquipmentPlayed,
                "soulFriendlyUnitsKilled" => TrackedValue.SoulFriendlyUnitsKilled,
                "soulKillAnyBoss" => TrackedValue.SoulKillAnyBoss,
                "soulKillLifemotherUsingAwoken" => TrackedValue.SoulKillLifemotherUsingAwoken,
                "soulKillLifemotherUsingBanished" => TrackedValue.SoulKillLifemotherUsingBanished,
                "soulKillLifemotherUsingHellhorned" => TrackedValue.SoulKillLifemotherUsingHellhorned,
                "soulKillLifemotherUsingLazarusLeague" => TrackedValue.SoulKillLifemotherUsingLazarusLeague,
                "soulKillLifemotherUsingLunaCoven" => TrackedValue.SoulKillLifemotherUsingLunaCoven,
                "soulKillLifemotherUsingPyreborne" => TrackedValue.SoulKillLifemotherUsingPyreborne,
                "soulKillLifemotherUsingRailforged" => TrackedValue.SoulKillLifemotherUsingRailforged,
                "soulKillLifemotherUsingRemnant" => TrackedValue.SoulKillLifemotherUsingRemnant,
                "soulKillLifemotherUsingStygian" => TrackedValue.SoulKillLifemotherUsingStygian,
                "soulKillLifemotherUsingUmbra" => TrackedValue.SoulKillLifemotherUsingUmbra,
                "soulKillLifemotherUsingUnderlegion" => TrackedValue.SoulKillLifemotherUsingUnderlegion,
                "soulKillLifemotherUsingWurmkin" => TrackedValue.SoulKillLifemotherUsingWurmkin,
                "soulKillRegion1Boss" => TrackedValue.SoulKillRegion1Boss,
                "soulKillRegion2Boss" => TrackedValue.SoulKillRegion2Boss,
                "soulKillRegion3Boss" => TrackedValue.SoulKillRegion3Boss,
                "soulKillRegion4Boss" => TrackedValue.SoulKillRegion4Boss,
                "soulMagicPowerBonusDamage" => TrackedValue.SoulMagicPowerBonusDamage,
                "soulMerchantPurchases" => TrackedValue.SoulMerchantPurchases,
                "soulPyreDamageTaken" => TrackedValue.SoulPyreDamageTaken,
                "soulSpellsConsumed" => TrackedValue.SoulSpellsConsumed,
                "soulSpellsPurged" => TrackedValue.SoulSpellsPurged,
                "soulSpellsUpgraded" => TrackedValue.SoulSpellsUpgraded,
                "soulStarterCardsPlayed" => TrackedValue.SoulStarterCardsPlayed,
                "soulsUnlocked" => TrackedValue.SoulsUnlocked,
                "soulTreasureCollectorsKilled" => TrackedValue.SoulTreasureCollectorsKilled,
                "soulUnitDamageDealt" => TrackedValue.SoulUnitDamageDealt,
                "soulUnitDamageTaken" => TrackedValue.SoulUnitDamageTaken,
                "soulUnitsEaten" => TrackedValue.SoulUnitsEaten,
                "soulUnitsExtinguishTriggered" => TrackedValue.SoulUnitsExtinguishTriggered,
                "soulUnitsMoved" => TrackedValue.SoulUnitsMoved,
                "soulUnitsPurged" => TrackedValue.SoulUnitsPurged,
                "soulUnitsRevengeTriggered" => TrackedValue.SoulUnitsRevengeTriggered,
                "soulUnitsSummoned" => TrackedValue.SoulUnitsSummoned,
                "soulUnitsUpgraded" => TrackedValue.SoulUnitsUpgraded,
                _ => null,
            };
        }
        ...
        public static TitanAffinity? ParseTitanAffinity(this IConfigurationSection section)
        {
            ...
            return val.ToLower() switch
            {
                ...
                "lifemother" => TitanAffinity.Lifemother,
                _ => null, // Invalid input
            };
        }
